...
### Load the data and functions used in this analysis

To get a local version of the data and functions used for this analysis, you can 
run the following code. This will download a local copy of all the files contained
in the GitHub repository "Guide to DID estimators" on Corinne Riddell's GitHub.
...
The files will open in RStudio when you run this code. In the future, you can 
...
```{r}
#FOR CORINNE TO DOUBLE CHECK - THINK I CAN REMOVE THIS/MODIFY AS THE USETHIS CODE 
#WILL LOAD THESE IN FOR THE USER...
...
# use `source()` to read in the functions here: 
...
or dynamic. Using a "time since treatment" indicator will estimate effects 
...
time make sense? I am inclined to start by estimating a dynamic effect to see
