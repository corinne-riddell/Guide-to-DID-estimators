...
found in Eli Ben-Michael's linked GitHub repository. The other helper functions 
...
we use either the `fit_event_jack_sum()` function or `fit_event_jack_sum_hte()`
functions. The functions estimate different causal effects, so choose the one 
that corresponds in the effect estimate you are interested in.
